...
import { PerfilUsuarioActions, actions } from '../../actions/seguridad/perfil-usuario.actions';
...
export function perfilUsuarioReducer(state = INITIAL_STATE, action: PerfilUsuarioActions): State<any> {
  switch (action.type) {
    case actions.RESET:
