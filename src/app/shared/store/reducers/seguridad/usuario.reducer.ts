...
import {actions, UsuarioActions} from "../../actions/seguridad/usuario.actions";

const INITIAL_STATE: State<UsuarioSeg> = {
  data: [],
  selected: null,
  action: null,
  loading: false,
...
export function usuarioReducer(state = INITIAL_STATE, action: UsuarioActions): State<UsuarioSeg> {
  switch (action.type) {
